...
describe('BookListComponent', () => {
 ...
 beforeEach(() => {
   ...
   component.series = [
     new Serie(faker.datatype.number(), faker.name.firstName(), faker.name.firstName(), faker.datatype.number(), faker.name.firstName(), faker.name.firstName(), faker.name.firstName())
   ]
